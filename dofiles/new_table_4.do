...
xml_tab  reg3 reg4  reg6 reg7  reg9  reg11, save("tables/new_table_4.xml") replace stats(mean testp testnegss N r2_a) below ///
...
xml_tab  reg1 reg2  reg4 reg5 , save("tables/new_table_4.xml") append stats(mean testp testnegss N r2_a) below ///
