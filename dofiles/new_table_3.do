...
local controls  both_parents_alive live_with_bio_dad live_with_bio_mom live_with_mom_dad ///
	parents_pay_fees read_nyanja_excel speak_nyanja_excel read_english_excel bl_age age2 ///
...
xml_tab  reg3 reg4  reg6 reg7  reg9 reg10 , save("tables/new_table_3.xml") replace stats(testp  mean N r2_a) below ///
...
xml_tab  reg1 reg2  reg4 reg5 , save("tables/new_table_3.xml") append stats(testp  mean N r2_a) below ///
