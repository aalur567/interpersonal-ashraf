...
xml_tab  reg7  reg1 reg2 reg3 reg3_2 reg4 reg6   , save("tables/new_table_3.xml") replace below stats( tran_neg tran_safe mean testp   N r2_a) ///
...
xml_tab OUT  , save("tables/new_table_3.xml") append  ///
