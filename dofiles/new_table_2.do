...
xml_tab  reg3 reg4  reg6 reg7  reg9 reg10 , save("tables/new_table_2.xml") replace stats(testp  mean N r2_a) below ///
...
xml_tab  reg1 reg2  reg4 reg5 , save("tables/new_table_2.xml") append stats(testp  mean N r2_a) below ///
