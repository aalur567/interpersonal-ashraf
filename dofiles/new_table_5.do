...
xml_tab   investmentcomm00 investmentcomm0  all00 all0 , save("tables/new_table_5.xml") replace below stats(testp avg N r2_a) ///
	keep(negotiation safespace  commXNeg commXSS ) ///
	cnames( /// 
	"Comm, Baseline Controls" "Double Lasso" "Pooled, Baseline Controls" "Double Lasso"  ) ///
	sheet("PanelA")

xml_tab   investmentnocomm00 investmentnocomm0   DG00 DG0 , save("tables/new_table_5.xml") append below stats(testp avg N r2_a) ///
